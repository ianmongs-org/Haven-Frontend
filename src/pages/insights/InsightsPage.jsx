...
export const InsightsPage = () => {
  ...
  const filteredInsights = Array.isArray(insights)
    ? insights.filter((insight) => {
        const matchesFilter =
          filter === "all" || insight.type?.toLowerCase() === filter;
        const matchesSearch =
          searchQuery === "" ||
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <button
                className="flex underline text-gray-500 text-sm items-center gap-2 cursor-pointer h-10 font-medium hover:text-gray-900 ease-in-out duration-300  border-0 border-black rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
